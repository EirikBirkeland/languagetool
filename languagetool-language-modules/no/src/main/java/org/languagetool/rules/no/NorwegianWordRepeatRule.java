...
public class EnglishWordRepeatRule extends WordRepeatRule {
  ...
  public NorwegianWordRepeatRule(final ResourceBundle messages, final Language language) {
    ...
    addExamplePair(Example.wrong("Dette <marker>er er</marker> bare en eksempelsetning."),
                   Example.fixed("Dette <marker>er</marker> bare en eksempelsetning."));
  }

  @Override
  public String getId() {
    return "NORWEGIAN_WORD_REPEAT_RULE";
  }
